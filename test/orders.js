...
function testMemBlt() {
    ...
    // Field Flags Bytes: 0xFF, 0x03 (using 7-bit encoding: 0xFF & 0x7F = 0x7F, 0x03 << 7 = 0x0180. 0x7F | 0x0180 = 0x01FF)
    // Fields:
    //   cacheId: 1 (0x0001)
    //   nLeftRect: 10 (0x000A)
    //   nTopRect: 10 (0x000A)
...
function testPatBlt() {
    ...
    // Field Flags Bytes: 0xFF, 0x1F (using 7-bit encoding: 0xFF & 0x7F = 0x7F, 0x1F << 7 = 0x0F80. 0x7F | 0x0F80 = 0x0FFF)
    // Fields:
    //   nLeftRect: 10
    //   nTopRect: 10
    //   nWidthRect: 100
...
function testLineTo() {
    ...
    // Field Flags Bytes: 0xFF, 0x07 (using 7-bit encoding: 0xFF & 0x7F = 0x7F, 0x07 << 7 = 0x0380. 0x7F | 0x0380 = 0x03FF)
    // Fields:
    //   mixMode: 1
    //   nXStart: 0
    //   nYStart: 0
...
function testMem3Blt() {
    ...
    // Field Flags Bytes: 0xFF, 0xFF, 0x03 (using 7-bit encoding: 0x7F | (0x7F << 7) | (0x03 << 14) = 0x7F | 0x3F80 | 0xC000 = 0xFFFF)
    // Fields:
    //   cacheId: 1
    //   nLeftRect: 10, nTopRect: 10, nWidthRect: 32, nHeightRect: 32
    //   bRop3: 0xCC
    //   nXSrc: 0, nYSrc: 0
    //   backColor: 0x000000, foreColor: 0xFFFFFF
    //   brushX: 0, brushY: 0, brushStyle: 0, brushHatch: 0, brushExtra: 7 bytes
    //   cacheIndex: 5
...
function testMultiOpaqueRect() {
    ...
    // Field Flags: 0x7F (all 7 fields present)
    // Fields:
    //   nLeftRect: 10, nTopRect: 20, nWidthRect: 100, nHeightRect: 50
    //   colorIndex: 0x00FF0000
    //   numRectangles: 1
    //   cbData: 4
    //   rects: 1 delta rect
    //     left delta: 10 -> 10 + 10 = 20
    //     top delta: 5 -> 20 + 5 = 25
    //     width delta: 0 -> 100 + 0 = 100
    //     height delta: 0 -> 50 + 0 = 50
    ...
    assert.strictEqual(order.fields.rects[0].left, 20);
    assert.strictEqual(order.fields.rects[0].top, 25);
    assert.strictEqual(order.fields.rects[0].width, 100);
    assert.strictEqual(order.fields.rects[0].height, 50);
