...
function testOpaqueRect() {
    ...
    // Field Flags: 0x1F (all 5 fields present) -> 7-bit encoded: 0x1F
    // Fields:
    //   nLeftRect: 10 (0x000A)
    //   nTopRect: 20 (0x0014)
...
function testScrBlt() {
    ...
    // Field Flags: 0x7F (all 7 fields present) -> 7-bit encoded: 0x7F
    // Fields:
    //   nLeftRect: 50 (0x0032)
    //   nTopRect: 60 (0x003C)
...
function testMemBlt() {
    ...
    // 7-bit encoded Field Flags: 0x01FF -> (0xFF & 0x7F) | 0x80 = 0xFF, (0x01FF >> 7) = 0x03 -> 0xFF, 0x03
    // Fields:
    //   cacheId: 1 (0x0001)
    //   nLeftRect: 10 (0x000A)
    //   nTopRect: 10 (0x000A)
...
function testPatBlt() {
    ...
    // 7-bit encoded Field Flags: 0x0FFF -> (0xFF & 0x7F) | 0x80 = 0xFF, (0x0FFF >> 7) = 0x1F -> 0xFF, 0x1F
    // Fields:
    //   nLeftRect: 10
    //   nTopRect: 10
    //   nWidthRect: 100
...
function testLineTo() {
    ...
    // 7-bit encoded Field Flags: 0x03FF -> (0xFF & 0x7F) | 0x80 = 0xFF, (0x03FF >> 7) = 0x07 -> 0xFF, 0x07
    // Fields:
    //   mixMode: 1
    //   nXStart: 0
    //   nYStart: 0
...
function testMem3Blt() {
    ...
    // 7-bit encoded Field Flags: 0xFFFF -> (0xFF & 0x7F) | 0x80 = 0xFF, (0xFFFF >> 7) & 0x7F | 0x80 = 0xFF, (0xFFFF >> 14) = 0x03 -> 0xFF, 0xFF, 0x03
    // Fields:
    //   cacheId: 1
    //   nLeftRect: 10
    //   nTopRect: 10
...
function testMultiOpaqueRect() {
    ...
    //   colorIndex: 0xFF0000
    //   numRectangles: 1
    //   rectData (CodedDeltaList): 4 bytes
    //     left: 5 (0x05)
    //     top: 5 (0x05)
    //     width: 10 (0x0A)
    //     height: 10 (0x0A)
    ...
    assert.strictEqual(parser.orderState[orders.OrderType.TS_NEG_OPAQUERECT_INDEX].nLeftRect, 10);
