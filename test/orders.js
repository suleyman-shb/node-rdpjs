...
function testMemBlt() {
    ...
    // Field Flags Bytes: 0xFF, 0x03 (7-bit encoding: 0xFF = 11111111, 0x03 = 00000011 -> 1100000000) Wait.
    // 9 bits: 1 11111111.
    // Byte 1: 1 (extension) | bits 0-6 = 1111111 (0x7F) -> 0xFF
    // Byte 2: 0 (no extension) | bits 7-13 = 0000011 (0x03) -> 0x03
    // So 0xFF, 0x03 is correct for 9 fields.
    // Fields:
    //   cacheId: 1 (0x0001)
    //   nLeftRect: 10 (0x000A)
    //   nTopRect: 10 (0x000A)
...
function testPatBlt() {
    ...
    // Field Flags Bytes: 0xFF, 0x1F (7-bit encoding: 0x0FFF is 12 bits)
    // 12 bits: 1111 11111111.
    // Byte 1: 1 (ext) | 1111111 (0x7F) -> 0xFF
    // Byte 2: 0 (no ext) | 0011111 (0x1F) -> 0x1F
    // Fields:
    //   nLeftRect: 10
    //   nTopRect: 10
    //   nWidthRect: 100
...
function testLineTo() {
    ...
    // Field Flags Bytes: 0xFF, 0x07 (7-bit encoding: 10 bits)
    // 10 bits: 111 1111111.
    // Byte 1: 1 (ext) | 1111111 (0x7F) -> 0xFF
    // Byte 2: 0 (no ext) | 0000111 (0x07) -> 0x07
    // Fields:
    //   mixMode: 1
    //   nXStart: 0
    //   nYStart: 0
...
function testMem3Blt() {
    ...
    // Field Flags Bytes: 0xFF, 0xFF, 0x03 (7-bit encoding: 16 bits)
    // 16 bits: 11 1111111 1111111.
    // Byte 1: 1 (ext) | 1111111 (0x7F) -> 0xFF
    // Byte 2: 1 (ext) | 1111111 (0x7F) -> 0xFF
    // Byte 3: 0 (no ext) | 0000011 (0x03) -> 0x03
    // Fields:
    //   cacheId: 1
    //   nLeftRect: 10
    //   nTopRect: 10
...
function testMultiOpaqueRect() {
    ...
    // Field Flags: 0x7F (all 7 fields present)
    // Byte 1: 0 (no ext) | 1111111 (0x7F) -> 0x7F
    // Fields:
    //   nLeftRect: 10
    //   nTopRect: 10
    //   nWidthRect: 100
    ...
    //   colorIndex: 0xFF0000
    //   numRectangles: 2
    //   cbData: 8 (4 packed values per rect * 2 rects. Each 1 byte here for simplicity)
    //   rectData:
    //     Rect 1 (delta from base: 10,10,109,109):
    //       left: +5 -> 15
    //       top: +5 -> 15
    //       right: +5 -> 114
    //       bottom: +5 -> 114
    //     Rect 2 (delta from rect 1):
    //       left: +5 -> 20
    //       top: +5 -> 20
    //       right: +5 -> 119
    //       bottom: +5 -> 119

    // Packed value for 5: 0x05 (isNegative=0, isTwoByte=0, value=5)
    ...
    assert.strictEqual(order.fields.rectData[1].left, 20);
    assert.strictEqual(order.fields.rectData[1].bottom, 119);
    ...
    assert.strictEqual(opaqueState.colorIndex, 0xFF0000);
