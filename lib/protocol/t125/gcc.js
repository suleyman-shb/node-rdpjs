...
function clientCoreData(opt) {
	var self = {
		...
		imeFileName : new type.BinaryString(Buffer.alloc(64), { readLength : new type.CallableValue(64), optional : true }),
		...
		clientDigProductId : new type.BinaryString(Buffer.alloc(64), { optional : true, readLength : new type.CallableValue(64) }),
...
function serverSecurityData(opt) {
	var self = {
		...
		serverRandomLen : new type.UInt32Le(null, { optional : true }),
		serverCertLen : new type.UInt32Le(null, { optional : true }),
		serverRandom : new type.BinaryString(null, {
			conditional : function() { return self.serverRandomLen.isRead && self.serverRandomLen.value > 0; },
			readLength : new type.CallableValue(function() {
				return self.serverRandomLen.value;
			})
		}),
		serverCertificate : new type.BinaryString(null, {
			conditional : function() { return self.serverCertLen.isRead && self.serverCertLen.value > 0; },
			readLength : new type.CallableValue(function() {
				return self.serverCertLen.value;
			})
		})
	};
