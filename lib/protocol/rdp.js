...
RdpClient.prototype.handshakeNLA = function (callback) {
	...
	var tsRequest = new credssp.TSRequest(2, new credssp.NegoData(ntlmNegotiate));
	...
	var onData = function(data) {
		...
		var tsResponse = credssp.decodeTSRequest(s);

		if (tsResponse.negoData) {
			var challenge = ntlm.decodeChallengeMessage(tsResponse.negoData.data);
			...
			var tsAuth = new credssp.TSRequest(2, new credssp.NegoData(authMsg));
