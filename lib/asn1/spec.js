 ...
 * @param decoder
 */
Asn1SpecExplicitTag.prototype.decode = function(s, decoder) {
 ...
 * @param encoder
 */
Asn1SpecExplicitTag.prototype.encode = function(encoder) {
	return encoder.encode(this.tag, this.spec.encode(encoder));
};
